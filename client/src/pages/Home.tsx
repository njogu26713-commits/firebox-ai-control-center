...
export default function Home() {
  ...
  const ownerActionsEnabled = !authLoading && Boolean(user);
  ...
  const handleGuestPreview = () => toast.info("Sign-in is required to run the live assistant preview.");
